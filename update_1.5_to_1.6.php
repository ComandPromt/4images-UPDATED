...
if (isset($HTTP_GET_VARS['action']) || isset($_POST['action'])) {
  $action = (isset($HTTP_GET_VARS['action'])) ? trim($HTTP_GET_VARS['action']) : trim($_POST['action']);
}
else {
  $action = "intro";
}
...
<p align="center">Powered by <b>4images</b> <?php echo SCRIPT_VERSION ?><br />
  Copyright &copy; 2002-2016 <a href="http://www.4homepages.de" target="_blank">4homepages.de</a>
</p>
</body>
</html>
