...
IconSelect.DEFAULT = {};
IconSelect.DEFAULT.SELECTED_ICON_WIDTH = '48px';
IconSelect.DEFAULT.SELECTED_ICON_HEIGHT = '48px';
...
function IconSelect($$elementID, $$parameters) {
    ...
    _View.createUI = function($parameters){
        ...
        _View.selectedIconImgElement = document.createElement('img');
     	_View.selectedIconImgElement.setAttribute('id', 'pais');
		...
		componentIconImgElement.setAttribute('value', IconSelect.COMPONENT_ICON_FILE_PATH );
        ...
        selectedIconElement.style.height = '50px';
        ...
        selectedBoxElement.style.height = '55px';
